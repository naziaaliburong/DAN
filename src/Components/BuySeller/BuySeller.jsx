  ...
  return (
    <div className="relative bg-white py-14 w-full px-5">
            ...
            <div className="w-full bg-white overflow-hidden shadow-top-bottom-lg p-6 grid grid-cols-5 gap-6 max-lg:grid-cols-2 max-lg:grid-rows-3 max-lg:gap-y-0 max-md:grid-cols-2 max-md:grid-rows-5">
              ...
              <div className="flex flex-col w-full col-span-2 h-[550px] border-r max-lg:border-r-0 border-gray-300 pr-6 max-lg:col-span-1 max-lg:row-span-2 max-md:col-span-2">
                ...
                <div className="relative w-full h-48 mb-4">
                  ...
                  />
                  <div className="absolute bottom-0 left-0 w-full h-[70%] bg-gradient-to-t from-black to-transparent bg-opacity-0 text-white p-5 pt-16">
                    <p className="text-2xl font-bold">{item.name}</p>
                    <p className="text-xl">{item.code}</p>
                  </div>
                </div>
                <div className="text-center">
                <p className="text-gray-700 text-2xl font-semibold">Time Left: {item.time}</p>
                </div>
              ...
              <div className="col-span-2 !m-0 overflow-hidden h-[550px] border-r max-md:border-r-0 border-gray-300 pr-6 max-lg:col-span-1 max-lg:row-span-2 max-md:col-span-2">
                <div className="flex border-b text-2xl font-semibold cursor-pointer">
                  ...
                  >
                    {item.status==="COMING SOON" ? "Buy Info" : "All Bids"}
                  </p>
                </div>
      
                <div className="mt-4 space-y-2">
                  {activeTab === "details" ? (
                    <div className="pt-3 space-y-3 text-gray-700 text-lg">
                      ...
                      <div className="flex justify-between bg-gray-100 p-4">
                        <span className="font-semibold">Bid Counter</span>
                        <span>10</span>
                      </div>
                      <div className="flex justify-between bg-gray-100 p-4">
                        <span className="font-semibold">Bid Start Price</span>
                        <span>10 SAR</span>
                      </div>
                      <div className="flex justify-between bg-gray-100 p-4">
                        <span className="font-semibold">Bid Start Time/Date</span>
                        <span>03/29/2024, 10:42:00 AM</span>
                      </div>
                    </div>
                  ) : (
